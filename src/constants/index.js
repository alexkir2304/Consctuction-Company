export const navigation = [
    {
        ...
        menuSectors: [
            {
                title: 'AboutUs',
                text: 'Turner is a North America-based, international construction services company and is a leading builder in diverse market segments.',
                links: [
                    {
                        url: '/about',
                        title: '',
...

    {
        ...
        menuSectors: [
            {
                title: 'Careers',
                text: 'An awarding and fulfilling career awaits you at Turner! Join our team and build some of the most exciting and innovative projects around the world.',
                links: [
                    {
                        url: '/careers',
                        title: 'Careers',
            ...
            },
            {
                ...
                links: [
                    {
                        url: '/careers',
                        title: 'Life at turner',
                    },
                    {
                        url: '/careers',
                        title: 'Turner careers',
                    },
                    {
                        url: '/careers',
                        title: 'Student and entry level',
                    },
                    {
                        url: '/careers',
